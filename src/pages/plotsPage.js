...
// recharts timesteps series plot
const newdata = [
  {
    name: 'Page A',
    uv: 4000,
        ...
        <Row >
              ...
              Global Extent
                    ...
                    >
                     {/* Timesteps plot */}
                        ...
                        <ResponsiveContainer width="100%" height={300}>
                            ...
                            >
                            <CartesianGrid  stroke={theme.colors.secondary} />
                            <XAxis dataKey="name" />
                            <YAxis />
                            <Tooltip />
                            <Legend onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} />
                            <Line type="monotone" dataKey="pv" strokeOpacity={opacity.pv} stroke="#8884d8"  />
                ...
                <Column start={[1, 7]} width={[6, 6]}>
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        ...
                        >
                        <CartesianGrid stroke={theme.colors.secondary} vertical={false} />
                        <XAxis dataKey="name" />
                        <YAxis />
                        <Tooltip />
                        <Legend />
            ...
            <Column start={[1, 1]} width={[13]}>
                <Box
                    ...
                    <Chart x={[0, 11]} y={[0, 100]} 
                            padding={{ left: 60, top: 60 }}
                            sx={{ width: '100%' }}>
                        <Grid vertical horizontal />
                        <Ticks left bottom />
                        <TickLabels left bottom />
                        <AxisLabel left>Evaluation metric</AxisLabel>
                        <AxisLabel bottom>Month</AxisLabel>
                        <Plot>
                        <Line
                            data={[
                            [0, 25],
